...
# ── Per-query title exclusion patterns ──
# Remove accessories/parts that mention the query keyword but aren't the item itself.
# E.g., "iPhone 14 pro max display" is a display, not an iPhone.
import re
